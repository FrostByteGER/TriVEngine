...
namespace TriV
{
	...
	void TriVEngine::createRenderPass()
	{
	...
	void TriVEngine::createFramebuffers()
	{
	...
	void TriVEngine::createCommandPool()
	{
	...
	void TriVEngine::createCommandBuffers()
	{
	...
	void TriVEngine::createSemaphores()
	{
	...
	VKAPI_ATTR VkBool32 VKAPI_CALL TriVEngine::DebugCallback(VkDebugReportFlagsEXT flags, VkDebugReportObjectTypeEXT objType, uint64_t obj, std::size_t location, int32_t code, const char* layerPrefix, const char* msg, void* userData) {
