...
namespace std {
	...
	template <typename T> struct hash<TriV::Engine::Utility::object_ptr<T>> {
		constexpr size_t operator()(TriV::Engine::Utility::object_ptr<T> const& p) const
			noexcept {
			return hash<T*>()(p.get());
		}
	};
	...
	typename std::enable_if<
		...
		TriV::Engine::Utility::object_ptr<To>>::type
		static_pointer_cast(TriV::Engine::Utility::object_ptr<From> p) {
	...
	typename std::enable_if<
		...
		TriV::Engine::Utility::object_ptr<To>>::type
		dynamic_pointer_cast(TriV::Engine::Utility::object_ptr<From> p) {
